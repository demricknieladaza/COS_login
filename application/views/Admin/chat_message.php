...
<div class="panel-footer">
    <div class="input-group">
        ...
        <span class="input-group-btn">
            <a type="submit" class="btn btn-warning btn-sm" id="btn-chat all" onclick="submitChat()" >Send</a>
            <a type="submit" class="btn btn-warning btn-sm" id="btn-chat my" style="display:none;" onclick="submitChats()" >Send</a>
        </span>
    </div>
</div>
</form>
